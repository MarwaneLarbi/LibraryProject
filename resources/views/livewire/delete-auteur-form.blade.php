<div>
    ...
    <!--begin::Form-->
    <!--begin::Form-->
    <form class="form"  id="deleteAuteurForm" data-kt-redirect="../../demo1/dist/apps/customers/list.html" enctype="multipart/form-data">
        @csrf
        <div>
            <input id="23" wire:modal="idauteur" value="" >
        </div>
        ...
        <div class="modal-body py-10 px-lg-17">
            ...
            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                ...
                <div class="fv-row mb-15">
                    ...
                    <textarea id="deleteauterdescription" name="content"></textarea>
                </div>
                <!--end::Billing form-->
            </div>
            <!--end::Scroll-->
...
@push('custom-scripts')
    ...
    <script>
        tinymce.init({
            selector: "#deleteauterdescription",
