        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="{{$auteur->description}}">
                ...
                <td class="text-end">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#deleteAuteur" onclick=" myfct()" data-bs-whatever="{{$auteur->id}}">Delete</a>
                ...
                <!-- Modal-deleteAuteur  -->
                <div  wire:ignore.self class="modal fade" id="deleteAuteur" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                    <div   class="modal-dialog modal-xl">
                        <div class="modal-content">
                            <!--begin::Form-->
                            @livewire('delete-auteur-form')
...
<script>
    ...
    var exampleModal = document.getElementById('deleteAuteur')
    exampleModal.addEventListener('show.bs.modal', function (event) {

        var button = event.relatedTarget
        var recipient = button.getAttribute('data-bs-whatever')

        document.getElementById("23").value = recipient;
    })
