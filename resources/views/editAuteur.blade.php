<div>
    ...
    <form class="form"  id="kt_modal_delete_auteur_form"  enctype="multipart/form-data">
        @csrf
        ...
        <div class="modal-footer flex-center">
            ...
            <!--end::Button-->
            <!--begin::Button-->
            <button type="submit" id="kt_modal_delete_auteur_submit" class="btn btn-primary">
...
@push('custom-scripts')
    <script>
        ...
        "use strict";var KTModalCustomersAdd=function()
        {
            ...
            init:function()
            {
                i=new bootstrap.Modal(document.querySelector("#kt_modal_delete_auteur")),
                    r=document.querySelector("#kt_modal_delete_auteur_form"),
                    t=r.querySelector("#kt_modal_delete_auteur_submit"),
                    e=r.querySelector("#kt_modal_delete_auteur_cancel"),
                    o=r.querySelector("#kt_modal_delete_auteur_close"),
                    n=FormValidation.formValidation(r,{
                        ...
                        e.preventDefault(),n&&n.validate().then((function(e){
                                var testdata = $('#kt_modal_delete_customer_form').serialize();
                                $.ajax({
                                    type: 'POST',
                                        ...
                                        if (data.success!=true) {
                                            "Valid"==e?(t.setAttribute("data-kt-indicator","on"),setTimeout((function(){
                                                    t.removeAttribute("data-kt-indicator"),Swal.fire({
                                                            ...
                                                            var data = $('#kt_modal_delete_customer_form').serialize();
